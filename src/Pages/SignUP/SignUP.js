    ...
    return (
        <div className='h-[800px] flex justify-center items-center'>
            <div className='w-96 p-7'>
                    <h2 className='lg:text-4xl md:text-3xl sm:text-2xl text-center'>Sign UP</h2>
                    ...
                    <input className='btn btn-accent text-white w-full mt-[30px]' value="Sign UP" type="submit" />
                    <div>
